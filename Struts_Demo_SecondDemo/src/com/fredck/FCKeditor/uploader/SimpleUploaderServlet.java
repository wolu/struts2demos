...
public class SimpleUploaderServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("===gamiao-Request Body is: " + request.toString()
				+ "\n");
		...
		System.out.println("===gamiao-typeStr: " + typeStr);

		String currentPath = baseDir + typeStr;
		String currentDirPath = getServletContext().getRealPath(currentPath);
		currentPath = request.getContextPath() + currentPath;

		System.out.println("===gamiao-currentPath: " + currentPath);
...
//			String saveDir = "D:\\file_tmp";
//			if (saveDir != null)
//				factory.setRepository(new File(saveDir));
//			System.out.println("===gamiao-saveDir: " + saveDir);
//			ServletFileUpload upload = new ServletFileUpload(factory);
//			upload.setHeaderEncoding(CJWGlobals.getCharacterEncoding());
//			maxSize = CJWGlobals.getLocalProperty("blog.photo.upload.maxSize",
//					62914560);
//			upload.setSizeMax(maxSize);
			...
			try {
				...
				System.out.println("=========gamiao-List size:" + items.size());
